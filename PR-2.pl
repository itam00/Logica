...
bucleCombinaciones:-forall(member(X,[0,1,2,3,4]),(buscarCombFila(X),buscarCombColumna(X))fo,eliminarColapsadosAux.
...
% atraviese a la fila desplazada, en caso de encontrar una combinacion
% marca el elemento encontrado en la fila y columna redibidas por
% parametro
